...
class App extends Component {
  ...
  getScoreCard = score => {
    ...
    return (
      <div className="score-card-container">
        <ScoreCard score={score} restartClicked={this.restartClicked} />
      </div>
    )
  }

  getGame = filteredImages => {
    const {displayImage, selectedTab} = this.state
    return (
  ...
  render() {
    const {isLost, selectedTab, score, timer} = this.state
    ...
    return (
      <div className="app-container">
        ...
        <nav className="nav-bar">
          ...
          />
          <ul className="t-and-s-container">
            <li className="nav-list-item">
              <p className="score-heading">
                Score: <span className="nav-content">{score}</span>
              </p>
            </li>
            <li className="nav-list-item">
              <img
                ...
                className="timer-img"
              />
              <p className="nav-content">{timer} sec</p>
            </li>
          </ul>
          {/* <div className="t-and-s-container">
            <p className="score-heading">
              Score: <span className="nav-content">{score}</span>
            </p>
        ...
        {/* NavBar Done Here */}
        {/* Game Content */}
        {isLost ? this.getScoreCard(score) : this.getGame(filteredImages)}
      </div>
    )
  }
}
